...
static const int user_bh            = 24 ;      /* 0 means that dwm will calculate bar height, >= 1 means dwm */
static const char *fonts[]          = { "JetBrains Mono Medium:size=10", "Hack Nerd Font:size=11", "JoyPixels:pixelsize=11:antialias=true:autohint=true"};
static char dmenufont[]             = "JetBrains Mono Medium:size=10";
static char normbgcolor[]           = "#222222";
static char normbordercolor[]       = "#444444";
static char normfgcolor[]           = "#bbbbbb";
static char selfgcolor[]            = "#eeeeee";
static char selbordercolor[]        = "#4dadd4";
static char selbgcolor[]            = "#5294E2";
static char *colors[][3] = {
       [SchemeNorm] = { normfgcolor, normbgcolor, normbordercolor},
       [SchemeSel] = { selfgcolor, selbgcolor, selbordercolor},
       [SchemeHid]  = { normbordercolor, selbordercolor, normbordercolor },
};
...
static Button buttons[] = {
	...
	{ ClkStatusText,        ShiftMask,      Button3,        sigdwmblocks,   {.i = 7} },/*SHCMD("st -e nvim ~/.local/src/dwmblocks/config.h")*/
